...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer, Contact{
        ...
        public String getPhoneNumber() {
            ...
            String tempPhoneNumber = String.valueOf(this.data.getPhoneNumber());
            ...
            return "+" + this.data.getCountryPhoneCode() + "(" + tempPhoneNumber.substring(0, 3) + ")" +
                    tempPhoneNumber.substring(3, 6) + "-" + tempPhoneNumber.substring(6, 8) + "-" + tempPhoneNumber.substring(8, 10);
        }
    }
